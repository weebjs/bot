...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const authorIds = ['ArB9z1qA', ''];

if (!authorIds.includes(message.author.id)) {
  return message.send("it seems you have requested for **Sage** bot status to be changed. but i cannot complete your request because you do not have the required permissions.");
}
